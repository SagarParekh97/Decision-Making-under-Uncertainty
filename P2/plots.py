...
plt.plot(episodes4, diss4, label='gamma = 0.99')
plt.plot(episodes5, diss5, label='gamma = 0.99')
plt.plot(episodes6, diss6, label='gamma = 0.99')
plt.plot(episodes7, diss7, label='gamma = 0.99')
plt.legend()
plt.xlabel('Episodes')
...
plt.plot(episodes4, entropy4, label='gamma = 0.99')
plt.plot(episodes5, entropy5, label='gamma = 0.99')
plt.plot(episodes6, entropy6, label='gamma = 0.99')
plt.plot(episodes7, entropy7, label='gamma = 0.99')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Entropy')
...
plt.plot(episodes4, vacuity4, label='gamma = 0.99')
plt.plot(episodes5, vacuity5, label='gamma = 0.99')
plt.plot(episodes6, vacuity6, label='gamma = 0.99')
plt.plot(episodes7, vacuity7, label='gamma = 0.99')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Vacuity')
...
plt.plot(episodes4, EMA_filter(reward4), label='gamma = 0.99')
plt.plot(episodes5, EMA_filter(reward5), label='gamma = 0.99')
plt.plot(episodes6, EMA_filter(reward6), label='gamma = 0.99')
plt.plot(episodes7, EMA_filter(reward7), label='gamma = 0.99')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Rewards')
