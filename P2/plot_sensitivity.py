...
plt.plot(episodes4, diss4, label='RLD_eps_0.2')
plt.plot(episodes5, diss5, label='RLD_eps_0.4')
plt.plot(episodes6, diss6, label='RLD_eps_0.1')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Dissonance')
...
plt.plot(episodes4, entropy4, label='RLD_eps_0.2')
plt.plot(episodes5, entropy5, label='RLD_eps_0.4')
plt.plot(episodes6, entropy6, label='RLD_eps_0.1')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Entropy')
...
plt.plot(episodes4, vacuity4, label='RLD_eps_0.2')
plt.plot(episodes5, vacuity5, label='RLD_eps_0.4')
plt.plot(episodes6, vacuity6, label='RLD_eps_0.1')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Vacuity')
...
plt.plot(episodes4, EMA_filter(reward4), label='RLD_eps_0.2')
plt.plot(episodes5, EMA_filter(reward5), label='RLD_eps_0.4')
plt.plot(episodes6, EMA_filter(reward6), label='RLD_eps_0.1')
plt.legend()
plt.xlabel('Episodes')
plt.ylabel('Rewards')
